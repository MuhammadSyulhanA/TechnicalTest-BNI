...
extension AppDelegate: UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication,
                     didReceiveRemoteNotification userInfo: [AnyHashable: Any], fetchCompletionHandler completionHandler: @escaping (UIBackgroundFetchResult) -> Void) async
    ...
    func navigateToDetail(_ deepLink: String) {
        ...
        for queryItem in queryItems {
            ...
            } else if queryItem.name == "transactionCode" {
                transactionCode = queryItem.value
            }
        }
        
        print("queryyy \(queryItems)")
        print("titel dan code \(String(describing: title)) \(String(describing: transactionCode))")
